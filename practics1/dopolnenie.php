...
$careerProfile = $data['career']['profile'];
$careerExp = $data['career']['experiences'];
...
<div class="wrapper">
        ...
        <div class="languages-container container-block">
            ...
            <ul class="list-unstyled interests-list">
                <?foreach ($languages as $lang) : ?>
                    <li><?=$lang['lang'] ?><span class="lang-desc">(<?=$lang['level'] ?>)</span></li>
                <? endforeach; ?>
            </ul>
        </div><!--//interests-->
    ...
    <div class="main-wrapper">
        ...
        <section class="section projects-section">
            ...
            <? foreach ($project['info'] as $valueProject) : ?>
                <div class="item">
                    <span class="project-title"><a href="<?=$valueProject['url']?>"><?=$valueProject['name']?></a></span> - <span class="project-tagline"><?=$valueProject['detail']?></span>
                </div><!--//item-->
            <? endforeach; ?>
        </section><!--//section-->
        ...
        <section class="skills-section section">
            ...
            <div class="skillset">
                <? foreach ($skills as $valueSkills) : ?>
                    <div class="item">
                        <h3 class="level-title"><?= $valueSkills['type']?></h3>
                        <div class="level-bar">
                            <div class="level-bar-inner" data-level="<?= $valueSkills['level']?>">
                            </div>
                        </div><!--//level-bar-->
                    </div><!--//item-->
                <? endforeach; ?>
